...
Per the *heart-disease.names* file, the Switzerland data set contains 123 instances and 76 attributes. This confirms that the data set read from the *.data* file was imported correctly.
