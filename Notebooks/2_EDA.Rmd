...
grid.text("Top bars = Freq of combo, Side bars = total missing / feature", y = 0.91, gp = gpar(fontsize = 10))
...
The UpSet plot shows the intersections of variable sets, similar to a Venn Diagram. This plot shows the combinations of variables that have missing values and the total of thos combinations.
...
Group 1: "prop", "nitr", "pro", "diuretic", "exang" Group 2: "ladprox", "laddist", "cxmain", "om1", "rcaprox", "rcadist"
